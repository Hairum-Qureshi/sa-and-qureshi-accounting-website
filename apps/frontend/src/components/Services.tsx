...
const services: Service[] = [
  {
    icon: <TbCircleNumber1Filled className="text-blue-500" />,
  ...
  {
    icon: <TbCircleNumber2Filled className="text-blue-500" />,
    title: "Corporate Taxes",
    description:
      "Comprehensive corporate tax services to keep your business compliant and optimized.",
  },
  {
    icon: <TbCircleNumber3Filled className="text-blue-500" />,
    title: "Payroll Services",
    description:
      "Reliable payroll processing to ensure your employees are paid accurately and on time.",
  },
  {
    icon: <TbCircleNumber4Filled className="text-blue-500" />,
    title: "Establishing a New Company",
    description:
      "End-to-end guidance to help you start your new business the right way.",
  },
  {
    icon: <TbCircleNumber5Filled className="text-blue-500" />,
    title: "General Business Services",
    description:
      "Support for your day-to-day business operations and finanical needs.",
  },
  {
    icon: <TbCircleNumber6Filled className="text-blue-500" />,
    title: "Immigration Services",
    description: "Professional assistance with your immigration needs.",
  },
  {
    icon: <TbCircleNumber7Filled className="text-blue-500" />,
    title: "Visa/Passport Processing",
    description: "Efficient processing for visa and passport applications.",
  },
  {
    icon: <TbCircleNumber8Filled className="text-blue-500" />,
